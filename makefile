...
# readme
## index.html
docs/index.html: docs/badges.markdown docs/README.md docs/download.csv docs/download-all.csv
	pandoc $(pandocArgHTML) docs/badges.markdown docs/README.md -o $@
## GitHub README
README.md: docs/badges.markdown docs/README.md docs/download.csv docs/download-all.csv
 ...
 docs/download.csv:
	...
	docs/download.py -o $@ --formats .epub .pdf
